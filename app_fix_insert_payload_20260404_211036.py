...
def customer_secure_apply():
    ...
    try:
        ...
        loan_amount = to_float(form.get("loan_amount"), 0)
        ...
        monthly_income = to_float(form.get("monthly_income"), 0)
        other_income = to_float(form.get("other_income"), 0)
        ...
        safe_payload = _filter_payload_to_existing_columns(app_table, payload)`r`n        supabase_admin.table(app_table).insert(safe_payload).execute()
